            ...
            (e._doQuery = function(t, r, n, a) {
              ...
              u =
                '/namespaces' === o
                  ...
                  : e.apiBaseUrl + ('*' === n ? '' : '/namespaces/' + n) + o;
              var l = this._getParameters(r);
              return e
                ._authenticate(t)
                .then(function() {
                  return e._request(t, s, u, l);
                })
                .then(function(e) {
                  return e.data;
                })
          ...
          function e(e, t, r) {
            ...
            (this.instanceSettings = e),
              ...
              (this._getApiUrl = function(e) {
                var t = u.a.find(l, {value: e.apiEndpoints});
                return t ? t.url : l[0].url;
              }),
              ...
              (this._queryGroupAndAggregate = function(e, t) {
                ...
                if (o) {
                  ...
                  return a._mergeTableAggregation(g, f || o, l);
                }
                return [a._queryAggregation(e, l, t)];
              }),
              ...
              (this.resolvePaths = function(e, t) {
                ...
                if ('*' !== n) return [i];
                var o = a._deepResolve(r);
                return '' === i
                  ? o
                  : u.a.map(o, function(e) {
                      return i + '.' + e;
                    });
              }),
                ...
                var t = (function(e) {
                  ...
                  if (void 0 !== a[6])
                    for (
                      ...
                      if (void 0 !== o[1]) {
                        var l = {
                          type: 'fieldSelector' === o[1] ? n.FIELD : n.LABEL,
                          key: o[2],
                          matcher: o[3],
                          value: o[4],
                        };
                        i.serverFilters.push(l);
                      } else
                        (l = {
                          key: o[5],
                          matcher: '=' === o[6] ? '==' : o[6],
                ...
                return s
                  ...
                  .then(function(r) {
                    return 'field' === o
                      ...
                      : 'aggregation' === o ? t._queryGroupAndAggregate(r, e) : [];
                  });
              });
          ...
          function t(t, r, a, i, f) {
            ...
            (p.$q = a),
              ...
              (p.getCurrentAggregationType = function() {
                return u.a.find(o, {value: p.target.aggregationType});
              }),
              ...
              (p.getFieldSelectorOptions = function(e, t, r) {
                ...
                if (p.dataPreview && 0 < p.dataPreview.length) {
                  ...
                  if (0 < r)
                    for (var s = 0; s < r; s++) {
                      var o = p.target.fieldSelectors[t].fieldSegments[s];
                      i = u.a.get(i, o.value);
                    }
                  (a = u.a.concat(a, ['*'])),
              ...
              (p._getCurrentApi = function() {
                return u.a.find(l, {value: p.target.apiEndpoints});
              }),
            ...
            return (
              ...
              void 0 === p.target.apiEndpoints && (p.target.apiEndpoints = l[0].value),
              ...
              void 0 === p.target.aggregationType &&
                (p.target.aggregationType = o[0].value),
              void 0 === p.target.aggregationRequiresTarget &&
                (p.target.aggregationRequiresTarget = o[0].requiresTarget),
