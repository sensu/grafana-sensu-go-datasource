define(['lodash', 'moment', 'app/core/app_events', 'app/plugins/sdk'], function(
  ...
  return (
    (i = [
      ...
      function(e, t, r) {
        ...
        ((t = n = n || {})[(t.FIELD = 0)] = 'FIELD'),
          ...
          (i._doQuery = function(e, t, r, n) {
            ...
            return i
              ...
              .catch(function(a) {
                ...
                var i = Math.floor(1e3 + 1e3 * Math.random());
                return new Promise(function(e) {
                  return setTimeout(e, i);
                }).then(function() {
                  return u._doQuery(e, t, r, n + 1);
                });
              });
          }),
          ...
          (i._acquireAccessToken = function(e) {
            return i._request(e, 'GET', '/auth').then(function(t) {
              ...
              r = t.expires_at - r - i.tokenTimeout_s;
              (t.expires_offset = r), (e.instanceSettings.tokens = t);
            });
          }),
          ...
          (i._getParameters = function(e) {
            var t,
              r = e.limit,
              a = ((e = e.responseFilters), {});
            return (
              '' !==
                (t = ('' !==
                  (t = this._buildFilterParameter(
                    e.filter(function(e) {
                      return e.type === n.FIELD;
                    })
                  )) && (a.fieldSelector = t),
                this._buildFilterParameter(
                  e.filter(function(e) {
          ...
          (i.grafanaMultiValueRegex = new RegExp(/^\s*[(].*[|].*[)]\s*$/g));
        var u = i,
          s = [
          ...
          f = function(e, t, r) {
            ...
            if ('=~' === t || '!~' === t) {
              ...
              return '=~' === n ? u.test(i) : !u.test(i);
            }
            if ('<' !== t && '>' !== t) throw 'Unsupported operator "' + t + '"';
            return (
              (n = e),
              (u = t),
              (i = r),
            ...
            return (
              ...
              1 === r &&
                ...
                (r = a()(r)
                  ...
                  .value()),
                delete t.filterSegments,
                (t.clientSideFilters = r),
                (t.serverSideFilters = []),
                (t.version = 2)),
              e
            );
          ...
          (this.instanceSettings = e),
            ...
            (this._resolveTemplateVariables = function(e, t) {
              var r = e.target,
                n = e.clientFilters,
                a = ((e = e.serverFilters),
                i.templateSrv.replace(r.namespace, t.scopedVars, 'pipe').split('|'));
              (r.namespaces = a),
            ...
            (this._queryAggregation = function(e, t, r) {
              ...
              if ('sum' === n)
                return (function(e, t, r) {
                  return r
                    ? ((e = a.a.sumBy(e, r)),
                      [{name: t, value: (e = a.a.isFinite(e) ? e : null)}])
                    : [];
        ...
        (y.$inject = ['instanceSettings', 'backendSrv', 'templateSrv']),
            ...
            return 0 === n.length
              ...
              : ((t = n.map(function(e) {
                  ...
                  t = {
                    ...
                    namespaces: o,
                    limit: (c =
                      (c = a.a.defaultTo(parseInt(c || ''), -1)) < 0
                        ? 'aggregation' === s ? 0 : 100
                        : c),
                    responseFilters: i,
                  };
                  return u
                    .query(r, t)
                    .then(r._timeCorrection)
                    .then(function(e) {
                      return r._filterData(e, n);
                    })
                    .then(function(t) {
                      return 'field' === s
                        ? r._queryFieldSelection(t, l)
                        : 'aggregation' === s ? r._queryGroupAndAggregate(t, e) : [];
                    });
                })),
                  ...
                  return e.resultAsPlainArray
                    ...
                    : {
                        data: a.a.flatMap(t, function(e, t) {
                          return 'series' === (t = n[t].target.format)
                            ? S(e)
                            : d(e, 'table-v' === t);
                        }),
                      };
        ...
        var T,
          ...
          (k.$inject = ['$scope', '$injector', '$q', 'uiSegmentSrv', 'templateSrv']),
          (k.prototype.getCollapsedText = function() {
            return (function(e) {
              var t,
          ...
          (k.templateUrl = 'partials/query.editor.html'),
          k);
        function k(e, t, r, i, g) {
          ...
          (f._addServerFilterSegment = function(e) {
            (e = [
              ...
              f.uiSegmentSrv.newFake('select filter key', 'value', 'query-segment-value'),
              f.uiSegmentSrv.newOperator('=='),
              f.uiSegmentSrv.newFake(
                'select filter value',
                'value',
          ...
          (f.getServerFilterOptions = function(e, t) {
            var r;
            return 'operator' === e.type
              ? f.$q.when(
                  f.uiSegmentSrv.newOperators(['==', '!=', 'in', 'notin', 'matches'])
                )
              : 'plus-button' === e.type || 'condition' === e.type
                ? f.$q.when(
                    a.a.map(['fieldSelector', 'labelSelector'], function(e) {
                      return f.uiSegmentSrv.newSegment({value: e});
                    })
                  )
                : ((r = a.a.map(f.templateSrv.variables, function(e) {
                    return '"$' + e.name + '"';
                  })),
                  'fieldSelector' === f.serverFilterSegments[t][0].value &&
                    (e = f._getCurrentApi()) &&
                    e.fieldSelectors.forEach(function(e) {
                      return r.push(e);
                    }),
                  (t = a.a.map(r, function(e) {
          ...
          h(f.target),
          f.target)).clientSideFilters),
            (i = t.serverSideFilters);
          return (
            a()(r)
        ...
        (q.$inject = ['$scope']), (q.templateUrl = 'partials/config.html');
        var E = q;
        function q(e) {
          var t = this;
  ...
  function a(e) {
    ...
    return (
      u[e] ||
      ((t = u[e] = {i: e, l: !1, exports: {}}),
      i[e].call(t.exports, t, t.exports, a),
      (t.l = !0),
      t)
    ).exports;
  }
